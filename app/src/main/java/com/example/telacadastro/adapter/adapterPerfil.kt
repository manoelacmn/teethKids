...
class  adpterPerfil(private val context: Context,private val perfil:MutableList<perfil>): RecyclerView.Adapter<adpterPerfil.PerfilViewHolder>(){ //esse adapter espera o viewholder -> os itens de cada lista
    inner class PerfilViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val descrição = itemView.findViewById<TextView>(R.id.nomeUsuario)
    ...
    override fun onBindViewHolder(holder: PerfilViewHolder, position: Int) {
        ...
        holder.analisar.bottom=perfil[position].analisar

    }
    override fun getItemCount(): Int { perfil.size
        //ele é responsavel pelo tamanho da lista
        TODO("Not yet implemented")
    }
}
